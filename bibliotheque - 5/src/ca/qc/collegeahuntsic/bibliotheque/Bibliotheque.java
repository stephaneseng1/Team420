...
public class Bibliotheque {
	...
	public static void main(String argv[]) throws Exception {
		...
		try {
			...
			InputStream sourceTransaction = Bibliotheque.class
					.getResourceAsStream("../../../../bibliotheque.dat");
	...
	static void executerTransaction(StringTokenizer tokenizer)
		...
		try {
			...
			if ("aide".startsWith(command)) {
				...
				Bibliotheque.LOGGER
						.info("  Transactions non reconnue.  Essayer \"aide\"");
			}
			...
			Bibliotheque.LOGGER.info("**** " + interruptedException.toString());
			gestionBiblio.rollbackTransaction();
		}
	}
	...
	static void afficherAide() {
		Bibliotheque.LOGGER
				.info("Chaque transaction comporte un nom et une liste d'arguments");
		Bibliotheque.LOGGER
				.info("separes par des espaces. La liste peut etre vide.");
		...
		Bibliotheque.LOGGER
				.info("  acquerir <titre> <auteur> <dateAcquisition>");
