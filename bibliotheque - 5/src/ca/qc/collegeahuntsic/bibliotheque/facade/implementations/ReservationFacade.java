...
public class ReservationFacade extends Facade implements IReservationFacade {
	 ...
	 */
	ReservationFacade(IReservationService reservationService)
			throws InvalidServiceException {
		super();
		if (reservationService == null) {
			throw new InvalidServiceException(
					"Le service de réservations ne peut être null");
		}
	...
	public void placer(Session session, ReservationDTO reservationDTO)
		...
		try {
			getReservationService().placer(session, reservationDTO);
	...
	public void annuler(Session session, ReservationDTO reservationDTO)
		...
		try {
			getReservationService().annuler(session, reservationDTO);
		} catch (ServiceException serviceException) {
			throw new FacadeException(serviceException);
		}
	}
