...
public interface IPretService extends IService {
	 ...
	 */
	void addPret(Session session, PretDTO pretDTO)
	 ...
	 *             Si la clef primaire du prêt est <code>null</code>
	 * @throws ServiceException
	 *             S'il y a une erreur avec la base de données
	 */
	PretDTO getPret(Session session, String idPret)
	 ...
	 *             S'il y a une erreur avec la base de données
	 */
	void updatePret(Session session, PretDTO pretDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			InvalidDTOClassException, ServiceException;
	 ...
	 *             S'il y a une erreur avec la base de données
	 */
	void deletePret(Session session, PretDTO pretDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			InvalidDTOClassException, ServiceException;
	 ...
	 *             S'il y a une erreur avec la base de données
	 */
	List<PretDTO> getAllPrets(Session session, String sortByPropertyName)
			throws InvalidHibernateSessionException,
	 ...
	 *             Si le prêt est <code>null</code>
	 * @throws InvalidPrimaryKeyException
	 *             Si la clef primaire du prêt est <code>null</code>, si la clef
	 *             primaire du membre est <code>null</code> ou si la clef
	 *             primaire du livre est <code>null</code>
	 * @throws MissingDTOException
	 ...
	 * @throws InvalidDTOClassException
	 *             Si la classe du membre n'est pas celle que prend en charge le
	 *             DAO ou si la classe du prêt n'est pas celle que prend en
	 *             charge le DAO
	 * @throws ServiceException
	 *             S'il y a une erreur avec la base de données
	 */
