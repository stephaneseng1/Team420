...
public class LivreService extends Service implements ILivreService {
	 ...
	 */
	@Override
	public LivreDTO getLivre(Session session, String idLivre)
			throws InvalidHibernateSessionException,
			InvalidPrimaryKeyException, ServiceException {
		try {
			return (LivreDTO) getLivreDAO().get(session, idLivre);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	 ...
	 */
	@Override
	public void updateLivre(Session session, LivreDTO livreDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			InvalidDTOClassException, ServiceException {
		try {
			getLivreDAO().update(session, livreDTO);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	 ...
	 */
	@Override
	public void deleteLivre(Session session, LivreDTO livreDTO)
			throws InvalidHibernateSessionException, InvalidDTOException,
			InvalidDTOClassException, ServiceException {
		try {
			getLivreDAO().delete(session, livreDTO);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	 ...
	 */
	@Override
	public List<LivreDTO> getAllLivre(Session session, String sortByPropertyName)
			throws InvalidHibernateSessionException,
	 ...
	 */
	@Override
	public List<LivreDTO> findLivreByTitre(Session session, String titre,
			String sortByPropertyName) throws InvalidHibernateSessionException,
			InvalidCriterionException, InvalidCriterionValueException,
			InvalidSortByPropertyException, ServiceException {
		try {
			return getLivreDAO()
					.findByTitre(session, titre, sortByPropertyName);
		} catch (DAOException daoException) {
			throw new ServiceException(daoException);
		}
	}
	...
	public void vendre(Session session, LivreDTO livreDTO)
			...
			InvalidPrimaryKeyException, ExistingLoanException,
		...
		LivreDTO unLivreDTO = getLivre(session, livreDTO.getIdLivre());
		if (unLivreDTO == null) {
			throw new MissingDTOException("Le livre " + livreDTO.getIdLivre()
					+ " n'existe pas");
		}
		...
		deleteLivre(session, unLivreDTO);
	}
}
