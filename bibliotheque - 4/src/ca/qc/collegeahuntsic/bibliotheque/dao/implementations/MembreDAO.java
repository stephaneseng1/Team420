...
public class MembreDAO extends DAO implements IMembreDAO {
    ...
    private static final String CREATE_REQUEST = "INSERT INTO membre (idMembre, nom, telephone, limitePret) "
        + "VALUES (?, ?, ?, ?)";

    private static final String READ_REQUEST = "SELECT idMembre, nom, telephone, limitePret "
        + "FROM membre "
        + "WHERE idMembre = ?";
    ...
    private static final String GET_ALL_REQUEST = "SELECT idMembre, nom, telephone, limitePret "
        + "FROM membre";

    private static final String FIND_BY_NOM = "SELECT idMembre, nom, telephone, limitePret "
        + "FROM membre "
